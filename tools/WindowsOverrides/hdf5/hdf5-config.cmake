...
execute_process(
        WORKING_DIRECTORY .
        COMMAND ${RSCRIPT_EXECUTABLE} --vanilla "-e" "pkgbuild::rtools_path()"
        OUTPUT_VARIABLE _R_TOOLS_location
        OUTPUT_STRIP_TRAILING_WHITESPACE
)
string(REGEX MATCHALL "\".*\"" _R_TOOLS_location "${_R_TOOLS_location}")
string(REGEX REPLACE "\"" "" _R_TOOLS_location "${_R_TOOLS_location}")
set(R_TOOLS_LOCATION ${_R_TOOLS_location})


get_filename_component(PACKAGE_PREFIX_DIR "${R_TOOLS_LOCATION}/../../x86_64-w64-mingw32.static.posix" ABSOLUTE)

# Use original install prefix when loaded through a "/usr move"
# cross-prefix symbolic link such as /lib -> /usr/lib.
get_filename_component(_realCurr "${CMAKE_CURRENT_LIST_DIR}" REALPATH)
get_filename_component(_realOrig "/usr/lib/mxe/usr/x86_64-w64-mingw32.static.posix/lib/cmake/hdf5" REALPATH)
...
set (${HDF5_PACKAGE_NAME}_SHARE_DIR "${PACKAGE_PREFIX_DIR}/lib/cmake")
...
if (NOT TARGET "hdf5")
  ...
  include (${CMAKE_CURRENT_LIST_DIR}/hdf5-targets.cmake)
endif ()
