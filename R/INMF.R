...
#' h5dense1 <- H5Mat(filename = system.file("extdata", "ctrl_dense.h5", package = "RcppPlanc", mustWork = TRUE),
#'                                           dataPath = "scaleData")
#' h5dense2 <- H5Mat(filename = system.file("extdata", "stim_dense.h5", package = "RcppPlanc", mustWork = TRUE),
#'                                           dataPath = "scaleData")
