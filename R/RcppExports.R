...
.rcpp_mat_to_h5mat <- function(x, filename, dataPath) {
    .Call(`_RcppPlanc_rcpp_mat_to_h5mat`, x, filename, dataPath)
}

.rcpp_spmat_to_h5mat <- function(data, rowind, colptr, nrow, ncol, filename, dataPath) {
    .Call(`_RcppPlanc_rcpp_spmat_to_h5mat`, data, rowind, colptr, nrow, ncol, filename, dataPath)
}

.rcpp_spmat_to_h5spmat <- function(value, rowind, colptr, nrow, ncol, filename, valuePath, rowindPath, colptrPath) {
    .Call(`_RcppPlanc_rcpp_spmat_to_h5spmat`, value, rowind, colptr, nrow, ncol, filename, valuePath, rowindPath, colptrPath)
}
...
.openblaspthreadoff <- function() {
    .Call(`_RcppPlanc_openblas_pthread_off`)
}

.openblaspthreadon <- function() {
    .Call(`_RcppPlanc_openblas_pthread_on`)
}
