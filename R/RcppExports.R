...
bppinmf_dense <- function(objectList, k, lambda, maxIter, thresh, verbose = TRUE, Hinit = NULL, Vinit = NULL, Winit = NULL) {
    .Call(`_RcppPlanc_bppinmf_dense`, objectList, k, lambda, maxIter, thresh, verbose, Hinit, Vinit, Winit)
}
