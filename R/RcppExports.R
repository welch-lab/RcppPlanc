...
.rcpp_mat_to_h5mat <- function(x, filename, datapath, overwrite, chunk_size = NULL) {
    .Call(`_RcppPlanc_RcppToH5Mat`, x, filename, datapath, overwrite, chunk_size)
}

.rcpp_spmat_to_h5spmat <- function(x, filename, datapath, overwrite) {
    .Call(`_RcppPlanc_RcppToH5Spmat`, x, filename, datapath, overwrite)
}
